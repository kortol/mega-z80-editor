...
- `packages/c-compiler/docs/scc-ts-migration.md`
- `packages/c-compiler/docs/scc-ts-full-c-coverage-phase0b.md`
- `packages/c-compiler/src/scc/tsFrontendSemantic.ts`
- `packages/c-compiler/src/scc/tsFrontendLowering.ts`
- `packages/c-compiler/src/scc/tsProgram.ts`
- `packages/c-compiler/src/scc/__tests__/tsCompilerAdapter.test.ts`

## Phase 0B

追加の証跡と matrix / ABI / fallback 棚卸しは `packages/c-compiler/docs/scc-ts-full-c-coverage-phase0b.md` を参照。
