...
export type SourceType = VoidTypeRef | {
    kind: "scalar";
    name: ScalarType;
    qualifiers?: TypeQualifiers;
} | AggregateTypeRef | PointerTypeRef | FunctionPointerTypeRef | {
    kind: "array";
    elementType: ScalarType;
...
export type SourceForInit = SourceSimpleStmt | {
    kind: "localDecl";
    name: string;
    type: SourceType;
    isStatic?: boolean;
...
export type SourceExpr = {
    ...
    kind: "pointerMemberExprArrayIndex";
    target: SourceExpr;
    field: string;
    index: SourceExpr;
} | {
