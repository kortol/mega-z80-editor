...
const listing_1 = require("./output/listing");
const sourceMap_1 = require("./output/sourceMap");
const analyze_1 = require("./analyze");
const macro_1 = require("./macro");
const pegAdapter_1 = require("./parser/pegAdapter");
...
function finalizeOutput(ctx, outputFile, relVersion) {
    if (relVersion === 2) {
        // v2 Writer 経由で出力
        (0, core_1.emitRelV2)(ctx, outputFile);
    }
    else {
    ...
    if (ctx.options.smap) {
        ...
        (0, core_2.writeSourceMap)(smapPath, smap);
    }
    // ------------------------------------------------------------
    // Verbose出力
    // ------------------------------------------------------------
