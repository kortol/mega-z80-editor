...
import { EXAMPLES_REPO_NAME, resolveExamplesPath, resolveExamplesRepoDir } from "@mz80/core";

const repoRoot = path.resolve(__dirname, "../../../..");
const examplesRoot = resolveExamplesRepoDir(repoRoot);

const packageLocalFiles = [
  "packages/assembler/src/__tests__/mac.inc",
  "packages/assembler/src/examples/sample.asm",
];
