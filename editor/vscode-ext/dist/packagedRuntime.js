...
const requirePackagedRuntime = (0, node_module_1.createRequire)(path.join(__dirname, "..", "server", "node_modules", "@mz80", "cli", "package.json"));
exports.packagedYaml = requirePackagedRuntime("yaml");
